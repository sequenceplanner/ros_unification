...
class agv_alvar_pose_publisher():

    def __init__(self):

        rospy.init_node('agv_pose_publisher', anonymous=False)

        self.tf_listener = tf.TransformListener()
        self.AGVAlvarPublisher = rospy.Publisher("agv_alvar_pose", Point, queue_size=10)
