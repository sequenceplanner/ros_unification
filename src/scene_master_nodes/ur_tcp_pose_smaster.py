...
class ur_tcp_pose_smaster():
    ...
    def __init__(self):
        ...
        self.AtBoltPair1TCPPose = [-0.0907433283046, -0.198958413547, 0.598781784017 + 0.015, -1.42736061959, -1.01986093313, 1.46158494504]
        ...
        self.AtBoltPair2TCPPose = [-0.170857851833, -0.198957378248, 0.598913374413 + 0.015, -1.42736275317, -1.01991528985, 1.46156533033]
        ...
        self.AtBoltPair3TCPPose = [-0.251764739397, -0.198932267163, 0.599280223362 + 0.015, -1.42737193363, -1.01978563604, 1.46151771638]

        self.FarAboveBoltPair4TCPPose = [-0.340180377452, -0.198928051199, 0.550467549074, -1.42746744193, -1.0197481687, 1.46158540087] 
        self.CloseAboveBoltPair4TCPPose = [-0.340216113173, -0.198929428147, 0.591334019607, -1.42742023128, -1.0197121412, 1.46154501591]
        self.AtBoltPair4TCPPose = [-0.340216113173, -0.198929428147, 0.591334019607 + 0.015, -1.42742023128, -1.0197121412, 1.46154501591]

        self.FarAboveBoltPair5TCPPose = [-0.42340282158, -0.198906066596, 0.550469298837, -1.4273482069, -1.01964894581, 1.46156326299] 
        self.CloseAboveBoltPair5TCPPose = [-0.42335253622, -0.198907648281, 0.593303203592, -1.42732440084, -1.01949546511, 1.46162737115]
        self.AtBoltPair5TCPPose = [-0.42335253622, -0.198907648281, 0.593303203592 + 0.015, -1.42732440084, -1.01949546511, 1.46162737115]

        self.FarAboveBoltPair6TCPPose = [-0.504277989694, -0.202548054041, 0.547506465843, -1.44351510935, -1.02205067085, 1.46146647002] 
        self.CloseAboveBoltPair6TCPPose = [-0.504257439148, -0.202509430763, 0.600940289801, -1.44328383836, -1.02178092267, 1.46150454678]
        self.AtBoltPair6TCPPose = [-0.504257439148, -0.202509430763, 0.600940289801 + 0.015, -1.44328383836, -1.02178092267, 1.46150454678]

        self.FarAboveBoltPair7TCPPose = [-0.572056239644, -0.202782081513, 0.56050845392, -1.49338121946, -1.06265925706, 1.42029634963] 
        self.CloseAboveBoltPair7TCPPose = [-0.572022944819, -0.202769953341, 0.603700582544, -1.4934025456, -1.06254790148, 1.42033656683]
        self.AtBoltPair7TCPPose = [-0.572022944819, -0.202769953341, 0.603700582544 + 0.015, -1.4934025456, -1.06254790148, 1.42033656683]

        self.FarAboveBoltPair8TCPPose = [-0.671600439824, -0.205083851779, 0.552170642121, -1.43285585336, -1.01947436425, 1.46210150502] 
        self.CloseAboveBoltPair8TCPPose = [-0.67164013522, -0.205040955238, 0.595909217147, -1.4329338934, -1.01950505222, 1.46198608899]
        self.AtBoltPair8TCPPose = [-0.67164013522, -0.205040955238, 0.595909217147 + 0.015, -1.4329338934, -1.01950505222, 1.46198608899]

        self.FarAboveBoltPair9TCPPose = [-0.756337995441, -0.205085148431, 0.554773477302, -1.43290604118, -1.01957035893, 1.46202542067] 
        self.CloseAboveBoltPair9TCPPose = [-0.756362925345, -0.205054927386, 0.594087198338, -1.43292290748, -1.0197174755, 1.46192571169]
        self.AtBoltPair9TCPPose = [-0.756362925345, -0.205054927386, 0.594087198338 + 0.015, -1.43292290748, -1.0197174755, 1.46192571169]

        self.FarAboveBoltPair10TCPPose = [-0.842457953839, -0.206941399681, 0.550707611477, -1.42751773056, -1.01930792912, 1.46186231147] 
        self.CloseAboveBoltPair10TCPPose = [-0.842439483256, -0.207014149385, 0.598627578333, -1.4274069005, -1.01975010409, 1.46153660082]
        self.AtBoltPair10TCPPose = [-0.842439483256, -0.207014149385, 0.598627578333 + 0.015, -1.4274069005, -1.01975010409, 1.46153660082]

        self.FarAboveBoltPair11TCPPose = [-0.925281939518, -0.207054574962, 0.543830160168, -1.42867750271, -1.01862144078, 1.46310135916] 
        self.CloseAboveBoltPair11TCPPose = [-0.925246708399, -0.207001465152, 0.592315204751, -1.42843417652, -1.01862363469, 1.46275547977]
        self.AtBoltPair11TCPPose = [-0.925246708399, -0.207001465152, 0.592315204751 + 0.015, -1.42843417652, -1.01862363469, 1.46275547977]

        self.FarAboveBoltPair12TCPPose = [-0.997709877071, -0.206914907744, 0.546649492367, -1.42969212723, -1.01763850947, 1.46391510099] 
        self.CloseAboveBoltPair12TCPPose = [ -0.997671436660, -0.20692410677, 0.594941151461, -1.42948482006, -1.0177939519, 1.46375133908]
        self.AtBoltPair12TCPPose = [ -0.997671436660, -0.20692410677, 0.594941151461 + 0.015, -1.42948482006, -1.0177939519, 1.46375133908]
        #----------------------------------------------------------------------------------------
    ...
    def FindEngineRightCollideTCP(self):
        self.moveL(self.FindEngineRightCollideTCP, a=0.3, v=0.05, t=0)
        while True:
            if self.z < -25:
    ...
    def FindEngineMidCollideTCP(self):
        ...
        while True:
            if self.z < -25:
                ...
                #print self.found_engine_mid_x
                #print self.found_engine_mid_y
                break
            else:
                pass
    ...
    def urTCPCallback(self, data):
        ...
        for pose in [self.FindEngineRightDownTCPPose,
            ...
            self.FindEngineMidCollideTCPPose,
